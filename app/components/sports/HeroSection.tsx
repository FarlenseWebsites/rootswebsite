...
export default function HeroSection() {
  return (
    <section className="relative aspect-[21/11] flex  overflow-hidden w-full">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto p-[clamp(1.25rem,3.1vw,3rem)]">
        
        <div className="w-[clamp(16rem,45vw,38rem)] pb-10"> {/* w-[clamp(16rem,40vw,32rem)] wraps the text exactly like the image */}
