  ...
  return (
    <footer className="bg-roots-footer-gray">
      <div className="max-w-7xl mx-auto px-4 md:px-10 py-12">
        ...
        {/* 
          MACRO LAYOUT: Asymmetric 12-Column CSS Grid 
          Mobile: 1 col -> Tablet: 2 cols -> Desktop: 12 cols (Proportional sizing)
        */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
          
          {/* Column 1 – Newsletter + Address (33.3% Desktop Width) */}
          <div className="sm:col-span-2 lg:col-span-4 flex flex-col gap-8 lg:pr-6">
            <div className="flex flex-col gap-3">
              <p className="text-sm text-[#4A4749] leading-snug font-medium">
                Sign up to receive updates from Roots Foundation.
              </p>
              
              <form 
                onSubmit={(e) => e.preventDefault()}
                className="flex border border-[#09569a] rounded overflow-hidden focus-within:ring-2 focus-within:ring-[#09569a]/50 transition-shadow"
              >
                <input
                  type="email"
                  value={email}
                ...
                <button 
                  type="submit"
                  className="shrink-0 px-4 py-2 bg-[#09569a] text-white text-sm font-medium hover:bg-[#09569a]/90 transition-colors"
                >
                  Subscribe
                </button>
              </form>
            ...
            <div className="flex items-start gap-3">
              <MapPin className="w-5 h-5 text-[#09569a] shrink-0 mt-0.5" />
          ...
          {/* Column 2 – Quick Links (16.6% Desktop Width - Fixes the massive gap) */}
          <div className="sm:col-span-1 lg:col-span-2 flex flex-col">
            <h3 className="text-base font-bold text-[#1a1a1a] mb-5">Quick Links</h3>
          ...
          {/* Column 3 – Impact Verticals (25% Desktop Width) */}
          <div className="sm:col-span-1 lg:col-span-3 flex flex-col">
            <h3 className="text-base font-bold text-[#1a1a1a] mb-5">Our Work</h3>
            <ul className="flex flex-col gap-3">
          ...
          {/* Column 4 – Partner With Us (25% Desktop Width) */}
          <div className="sm:col-span-2 lg:col-span-3 flex flex-col">
            <h3 className="text-base font-bold text-[#1a1a1a] mb-5">Partner With Us</h3>
            ...
            <Link
              href="/partner"
              className="inline-flex items-center justify-center w-full px-5 py-3 bg-[#09569a] text-white text-sm font-medium rounded hover:bg-[#09569a]/90 transition-colors mt-auto"
            >
              Partner With Us
            </Link>
          </div>
      ...
      <div className="border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 md:px-10 py-6 flex flex-col-reverse md:flex-row items-center justify-between gap-6">
          <p className="text-sm text-[#4A4749]">
            Copyright &copy; Roots Foundation {new Date().getFullYear()}. All Rights Reserved
          </p>
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-4">
              ...
              <a
                href="https://www.instagram.com/rootsfoundation.india"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#4A4749] hover:text-[#09569a] transition-colors"
            ...
            <a
              ...
              className="flex items-center gap-2 text-sm text-[#4A4749] hover:text-[#09569a] transition-colors"
            >
